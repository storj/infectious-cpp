...
#elif defined(INFECTIOUS_TARGET_SUPPORTS_ALTIVEC)
# include <altivec.h>
# undef vector
# undef bool
# define INFECTIOUS_SIMD_USE_ALTIVEC
...
#elif defined(INFECTIOUS_SIMD_USE_ALTIVEC)
# define INFECTIOUS_SIMD_ISA "altivec"
# define INFECTIOUS_VPERM_ISA "altivec"
#endif
   ...
   public:
      ...
      */
...
#elif defined(INFECTIOUS_SIMD_USE_NEON) && defined(INFECTIOUS_TARGET_ARCH_IS_ARM32)
...
#elif defined(INFECTIOUS_SIMD_USE_NEON) && defined(INFECTIOUS_TARGET_ARCH_IS_ARM64)
      ...
      static inline SIMD_4x32 choose(const SIMD_4x32& mask, const SIMD_4x32& a, const SIMD_4x32& b)
         {
#if defined(INFECTIOUS_SIMD_USE_ALTIVEC)
